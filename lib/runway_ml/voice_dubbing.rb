...
module RunwayML
  class VoiceDubbing
    ...
    def create(model:, audio_uri:, target_lang:, disable_voice_cloning: nil, drop_background_audio: nil, num_speakers: nil)
      errors = {}
      ...
      inputs = build_inputs(audio_uri, target_lang, disable_voice_cloning, drop_background_audio, num_speakers)
