  ...
  describe "#create" do
    context "with valid parameters" do
      it "validates and posts with https URL" do
        ...
        client.inject_response(:post, "voice_isolation", params: expected_params, response: { "id" => "task-isolation-123" })
        ...
        expect(result.id).to eq("task-isolation-123")
        expect(client).to have_been_called_with(method: :post, path: "voice_isolation", params: expected_params)
      end
      ...
      it "accepts runway URI" do
        ...
        client.inject_response(:post, "voice_isolation", params: expected_params, response: { "id" => "task-isolation-124" })
        ...
        expect(result).to be_a(RunwayML::Task)
        expect(result.id).to eq("task-isolation-124")
        expect(client).to have_been_called_with(method: :post, path: "voice_isolation", params: expected_params)
      end
      ...
      it "accepts data URI" do
        ...
        client.inject_response(:post, "voice_isolation", params: expected_params, response: { "id" => "task-isolation-125" })
        ...
        expect(result).to be_a(RunwayML::Task)
        expect(result.id).to eq("task-isolation-125")
        expect(client).to have_been_called_with(method: :post, path: "voice_isolation", params: expected_params)
      end
      ...
      it "accepts wav audio format" do
        ...
        client.inject_response(:post, "voice_isolation", params: expected_params, response: { "id" => "task-isolation-126" })
